    ...
    return recommended.length > 0 && (
        <div className="relative flex flex-col items-center px-6 md:px-16 lg:px-24 bg-gray-50 py-24">
            <div className={`transform transition-all duration-1000 ${
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto justify-items-center md:justify-items-stretch">
                    {recommended.slice(0, 4).map((room, index) => (
                        <div 
                            key={room._id} 
                            className={`transform transition-all duration-700 hover:scale-105 w-full max-w-sm md:max-w-none ${
