...
const HotelCard = ({room, index}) => {
  return (
    ...
    className='group relative max-w-70 w-full h-[520px] sm:h-[420px] rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200 hover:border-gray-300 flex flex-col'>
        {/* Display room image */}
        <div className="relative overflow-hidden h-52 sm:h-40 flex-shrink-0">
          <img 
            src={room.images[0]} 
            alt="hotel room"
          ...
          <div className='absolute top-3 right-3'>
            <span className='px-3 py-1 text-sm bg-white text-gray-800 font-semibold rounded-lg shadow-sm border border-gray-200'>
              ${room.pricePerNight}
                  ...
                  <div className='p-7 sm:p-5 flex flex-col flex-grow min-h-0'>
              {/* Hotel name and rating */}
              <div className='flex items-start justify-between mb-3 flex-shrink-0'>
                  <div className="flex-1 min-w-0">
                    <h3 className='font-playfair text-2xl sm:text-xl font-semibold text-gray-900 mb-1 line-clamp-2'>
                      {room.hotel.name}
                    </h3>
                    <p className="text-base sm:text-sm text-gray-500">{room.roomType}</p>
                  </div>
              ...
              {/* Location */}
              <div className='flex items-center gap-2 text-base sm:text-sm text-gray-600 mb-3 flex-shrink-0'>
              ...
              <div className='flex items-center justify-between mt-auto flex-shrink-0'>
                  <div>
                    ...
                    <p className='text-2xl sm:text-xl font-bold text-gray-900'>${room.pricePerNight}<span className='text-base sm:text-sm font-normal text-gray-500'>/night</span></p>
                  </div>
